...
public class ClienteNegocio<T> implements INegocio<T, Serializable> {
	...
	public String atualizar(T t) throws IOException, ClassNotFoundException, ExcecaoNaoCadastrado {
		dados.atualizar(t);
